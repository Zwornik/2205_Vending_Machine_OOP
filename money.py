...
class Money:
    INIT_NOMINATIONS = {200: 3, 100: 3, 50: 3, 20: 3, 10: 3, 5: 3, 2: 3, 1: 3, }  # initial nominations machine contains

    def __init__(self):
        self.money_in = Money.INIT_NOMINATIONS.copy() # Coins container, coins in pence e.g. {200: 2, 100: 1, 50: 1,...}
    ...
    def amount_in(self):  # print amount/value possessed
    ...
    def reset_bank(self):  # reset to initial state
        self.money_in = Money.INIT_NOMINATIONS.copy()  # Coins container, coins as dict e.g. {200: 2, 100: 1, 50: 1,...}
